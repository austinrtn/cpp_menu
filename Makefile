...
CMAKE_SOURCE_DIR = /storage/emulated/0/Android/data/ru.iiec.cxxdroid/files/text-based

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /storage/emulated/0/Android/data/ru.iiec.cxxdroid/files/text-based
...
all: cmake_check_build_system
	$(CMAKE_COMMAND) -E cmake_progress_start /storage/emulated/0/Android/data/ru.iiec.cxxdroid/files/text-based/CMakeFiles /storage/emulated/0/Android/data/ru.iiec.cxxdroid/files/text-based//CMakeFiles/progress.marks
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 all
	$(CMAKE_COMMAND) -E cmake_progress_start /storage/emulated/0/Android/data/ru.iiec.cxxdroid/files/text-based/CMakeFiles 0
.PHONY : all
